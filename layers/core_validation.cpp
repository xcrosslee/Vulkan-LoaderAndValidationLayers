...
static void PostCallRecordCmdDraw(
    ...
    vector<std::tuple<cvdescriptorset::DescriptorSet *, std::map<uint32_t, descriptor_req>, std::vector<uint32_t> const *>>
        *active_set_bindings_pairs,
    std::unordered_set<uint32_t> *active_bindings) {
    UpdateStateCmdDrawType(dev_data, cb_state, bind_point, CMD_DRAW, active_set_bindings_pairs, active_bindings);
}
...
static void PostCallRecordCmdDrawIndexed(
    ...
    vector<std::tuple<cvdescriptorset::DescriptorSet *, std::map<uint32_t, descriptor_req>, std::vector<uint32_t> const *>>
        *active_set_bindings_pairs,
    std::unordered_set<uint32_t> *active_bindings) {
    UpdateStateCmdDrawType(dev_data, cb_state, bind_point, CMD_DRAWINDEXED, active_set_bindings_pairs, active_bindings);
}
...
static void PostCallRecordCmdDrawIndirect(
    ...
    vector<std::tuple<cvdescriptorset::DescriptorSet *, std::map<uint32_t, descriptor_req>, std::vector<uint32_t> const *>>
        *active_set_bindings_pairs,
    std::unordered_set<uint32_t> *active_bindings) {
    UpdateStateCmdDrawType(dev_data, cb_state, bind_point, CMD_DRAWINDIRECT, active_set_bindings_pairs, active_bindings);
...
static void PostCallRecordCmdDrawIndexedIndirect(
    ...
    vector<std::tuple<cvdescriptorset::DescriptorSet *, std::map<uint32_t, descriptor_req>, std::vector<uint32_t> const *>>
        *active_set_bindings_pairs,
    std::unordered_set<uint32_t> *active_bindings) {
    UpdateStateCmdDrawType(dev_data, cb_state, bind_point, CMD_DRAWINDEXEDINDIRECT, active_set_bindings_pairs, active_bindings);
    AddCommandBufferBindingBuffer(dev_data, cb_state, buffer_state);
}
...
static void PostCallRecordCmdDispatch(
    ...
    vector<std::tuple<cvdescriptorset::DescriptorSet *, std::map<uint32_t, descriptor_req>, std::vector<uint32_t> const *>>
        *active_set_bindings_pairs,
    std::unordered_set<uint32_t> *active_bindings) {
    UpdateStateCmdDrawType(dev_data, cb_state, bind_point, CMD_DISPATCH, active_set_bindings_pairs, active_bindings);
}
...
static void PostCallRecordCmdDispatchIndirect(
    ...
    vector<std::tuple<cvdescriptorset::DescriptorSet *, std::map<uint32_t, descriptor_req>, std::vector<uint32_t> const *>>
        *active_set_bindings_pairs,
    std::unordered_set<uint32_t> *active_bindings) {
    UpdateStateCmdDrawType(dev_data, cb_state, bind_point, CMD_DISPATCHINDIRECT, active_set_bindings_pairs, active_bindings);
    AddCommandBufferBindingBuffer(dev_data, cb_state, buffer_state);
}
